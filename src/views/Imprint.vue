<template>
  <div class="imprint">
    ...
    <br>31832 Springe
    <br>
    <h2>Contact Information</h2>E-Mail:
    <a href="mailto:jan@jbeckmann.info">jan@jbeckmann.info</a>
    <br>Internet address:
    <a href="https://glo-ci.xyz" target="_blank">https://glo-ci.xyz</a>
    <br>
    <br>
    ...
    <a
      ...
      target="_blank"
    >translate-24h.de - Das Übersetzungsbüro im Internet</a>
    <br>
    <br>
  </div>
</template>
